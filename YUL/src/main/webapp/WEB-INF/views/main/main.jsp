...
<!-- CSS -->
<link rel="stylesheet" type="text/css" href="../resources/HTML/css/templatemo_style.css" />
<link rel="stylesheet" type="text/css" href="../resources/HTML/css/top_menu_20130205_1.css" />
<link rel="stylesheet" type="text/css" media="screen" href="../resources/HTML/css/nivo-slider.css" />
<!-- <link rel="stylesheet" type="text/css" href="../resources/HTML/css/ddsmoothmenu.css" /> -->
<!-- JAVASCRIPT -->
<!-- <script type="text/javascript" src="../resources/HTML/js/swfobject/swfobject.js"></script> -->
<script type="text/javascript" src="../resources/HTML/js/jquery/jquery-1.9.1.min.js"></script>
<!-- <script type="text/javascript" src="../resources/HTML/js/ddsmoothmenu.js"></script> -->
<script type="text/javascript" src="../resources/HTML/js/jquery.nivo.slider.pack.js"></script>
...
<div style="text-align: center;">
	<div id="templatemo_middle_wrapper">
		<div id="templatemo_slider" >
	        ...
	        <div id="slider" class="nivoSlider" style="text-align: center; position: relative; display: inline-table; margin: 50px;">
	            <img src="../resources/HTML/images/slider/01.jpg" alt="Slider 01" title="Nam porttitor, felis ac posuere sagittis, diam nisl convallis." />
	            <a href="#"><img src="../resources/HTML/images/slider/02.jpg" alt="Slider 02" title="Fusce sagittis, arcu a condimentum gravida." /></a>
	            <img src="../resources/HTML/images/slider/03.jpg" alt="Slider 03" title="Donec purus eros, dictum nec accumsan quis, auctor non eros."/>
	            <img src="../resources/HTML/images/slider/04.jpg" alt="Slider 04" title="Donec dignissim imperdiet orci sit amet posuere." />
	        </div>
...
<div id="templatemo_main">
	<div class="col_12 float_l">
        ...
        <img src="../resources/HTML/images/templatemo_image_01.jpg" alt="Image 01" class="float_l img_float_l" />
    ...
    <div class="col_12 float_r">
        ...
        <img src="../resources/HTML/images/templatemo_image_02.jpg" alt="Image 02" class="float_l img_float_l" />
    ...
    <div class="fp_box5">
        <img src="../resources/HTML/images/applications.png" alt="Image 01" />
    ...
    <div class="fp_box5">
        <img src="../resources/HTML/images/desktop_aurora_borealis.png" alt="Image 02" />
    ...
    <div class="fp_box5 no_margin_right">
        <img src="../resources/HTML/images/presentation.png" alt="Image 05" />
